import './buttonprimaryexternal.css'

interface ButtonPrimaryExternalProps {
    text: string;
    href: string;
}
export default function ButtonPrimaryExternal({ text, href }: ButtonPrimaryExternalProps) {
    return (
        <a href={href} className="button-external" target='_blank'>
            {text}
